        ...
        if(isset($_SESSION)) {
            if (is_null($_SESSION['partList']["$categoryName"])){
                ...
                $dhtml .= "<td class='col-md-2 vert-align'>
                            <img src='assets/img/shops/".strtolower($productVendor).".png' alt='Logo ".$productVendor."' width='50' height='50' /> <a href='$providerUrl' title='$productVendor'>". $productVendor ."</a>
                        </td>";
