...
from frags.items import OpticalDriveItem

class MySpider(CrawlSpider):
	name = "frags-opticalDrive"
	allowed_domains = ["4frags.com"]
	start_urls = ["http://www.4frags.com/hardware/dispositivos-opticos.html?limit=all"]
